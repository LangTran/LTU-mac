...
#
# Version 3.06, last edited 2019-12-12 at 16:59
# Mac version, which runs from /Applications/LangTranUpdate.app/Contents/MacOS
# The editable files and data downloaded are in /Users/Shared/LangTranLocal
#
# This version, when pruning the archive, does pushd to the folder
# and then calls PruneArchive.sh, then does popd back again.
#
LTData=/Users/Shared/LangTranLocal
echo 
...
echo `pwd`/$0
echo "Control files and the files downloaded are in $LTData"
...
cd $LTData ||
{
    echo "${MYNAME}: Can't cd to $LTData. Please investigate." >&2
    exit 1
}
